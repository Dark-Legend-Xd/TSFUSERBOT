...
DELETE_TIMEOUT = 3
thumb_image_path = "./Resources/photo_2021-10-31_10-23-29.jpg"
...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"TSF Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "TSF has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"TSF could not load {shortname} because of the following error.\n{str(e)}"
        )
