...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your TSF USERBOT 🐍", data="deploy")],
                [Button.url("Help Me ❓", "https://t.me/TSF_CHAT")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("Deploy Tutorial 📺", "TSF_USERBOT")],
                [Button.url("Need Help ❓", "https://t.me/TSF_CHAT")],
            ],
        )
